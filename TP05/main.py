...
# TP05 - Rotacion y traslacion (transformacion euclidiana)
...
def main() -> None:
    ...
    while True:
        ...
        if k == ord('e'):
            ...
            valid_tx, valid_ty, valid_angle = False, False, False
            ...
            # Apply euclidean transformation and save image.
            imgEuc = similarity(g.imgCrop, angle, tx, ty)
            cv2.imwrite('fotos/euclidean.png', imgEuc)
